...
public class User {
    ...
    public static void set_Matchs(ArrayList aMatchs) {
        User._matchs = aMatchs;
    }

    private static ArrayList<Match> _matchs = new ArrayList();

    public static ArrayList<Match> get_Matchs() {
        return _matchs;
    }

    public static void add_matchs(Match aIdMatchs) {
        User._matchs.add(aIdMatchs);
    }

    public static boolean matchExist(int index){
        for (Match m:
             _matchs) {
            if (m.get_idUser() == index){
                return true;
            }
        }
        return false;
