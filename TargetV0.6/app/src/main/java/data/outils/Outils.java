...
public class Outils {
    ...
    public static Connection connect (String nomBase) throws ClassNotFoundException, SQLException {
        ...
        props.put("user", "ottaviob_admin"); props.put("password", "roottoor+7-7"); props.put("charSet", "UTF-8");
        return DriverManager.getConnection("jdbc:mysql://ottaviob.mysql.db.hostpoint.ch/" + nomBase, props);
    } // connect
