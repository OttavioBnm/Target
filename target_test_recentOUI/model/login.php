...
<html lang="fr">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form class="leformulaire" action="login.php" method="post">
                    <h1 class="display-3">Connexion</h1>
			<div class="form-group">
				<label for="email">Adresse email</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrez votre adresse email" name="emailconnec">
				<small id="emailHelp" class="form-text text-muted">Nous ne partagerons votre email avec personne d'autres</small>
			</div>
			<div class="form-group">
				<label for="motdepasse">Mot de passe</label>
				<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Entrez votre mot de passe" name="passwordConnec">
			</div>
