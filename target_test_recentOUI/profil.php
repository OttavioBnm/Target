                                ...
                                <div class="media">
                                    <div class="media-body">
                                        <div class="card card-profile">
                                            <div align="center">
                                                <img class="thumbnail img-responsive profil" src="https://lut.im/7JCpw12uUT/mY0Mb78SvSIcjvkf.png" width="300px" height="300px">
                                            </div>
                                        </div>
                                        <hr id="propriete">
                                        ...
                                        <p>PDG - SpaceX</p>
                                        <hr>
                                        <h3><i class="fa fa-cog" aria-hidden="true"></i><strong> Modifier le profil</strong></h3>
                                        <hr>
                                    </div>
                                </div>
                            </div>
